...
type Props = {
  label: string;
  defaultValue: TMarginValue | null;
  onChange: (value: TMarginValue) => void;
};
export default function MarginInput({ label, defaultValue, onChange }: Props) {
  ...
  function handleChange(internalName: keyof TMarginValue, nValue: number) {
    const v = {
      ...value,
      [internalName]: nValue,
    };
